...
// ==================================================================
// mock_normDef - validate a layout and apply default lengths
// ==================================================================
dcl-proc mock_normDef export;
  dcl-pi *n ind;
...
// mock_isNumeric
// ==================================================================
dcl-proc mock_isNumeric export;
  dcl-pi *n ind;
    type char(10) const;
  end-pi;
...
// mock_validMatcher
// ==================================================================
dcl-proc mock_validMatcher export;
  dcl-pi *n ind;
...
// ==================================================================
// mock_rpgType - RPG free-form data type keyword for a layout
// ==================================================================
dcl-proc mock_rpgType export;
  dcl-pi *n varchar(64);
...
// ==================================================================
// mock_decode - render the value at ptr as text
// ==================================================================
dcl-proc mock_decode export;
...
// ==================================================================
// mock_encode - store text into the typed buffer at ptr
// ==================================================================
dcl-proc mock_encode export;
  dcl-pi *n ind;
    ptr pointer value;
    def likeds(mock_def_t) const;
  ...
  monitor;
    ...
    when def.type = '*PACKED' or def.type = '*ZONED';
      if not parseNum(t : def.len : def.dec : digs : neg);
        msg = '''' + t + ''' is not valid for ' + mock_rpgType(def);
        return *off;
      endif;
      if def.type = '*PACKED';
...
// ==================================================================
// mock_match - does an actual argument satisfy a matcher?
//   state: P = passed, O = *OMIT (null address), N = not passed
// ==================================================================
dcl-proc mock_match export;
  dcl-pi *n ind;
    matcher char(10) const;
