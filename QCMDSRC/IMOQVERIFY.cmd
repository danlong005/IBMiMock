/* IMOQVERIFY - iMoq: verify calls (escape IMQ0200 on failure)      */
             CMD        PROMPT('iMoq - Verify calls')
             ...
             PARM       KWD(TIMES) TYPE(VDEF) PROMPT('Times')
 ...
 VDEF:       ELEM       TYPE(*CHAR) LEN(9) RSTD(*YES) DFT(*EXACTLY) +
             ...
             ELEM       TYPE(*INT4) DFT(1) RANGE(0 9999999) +
                          PROMPT('Number of calls')
